...
@pytest.mark.parametrize("order, max_e, result", [
    ([20, 37, 20, 21], 1, [20, 37, 21]),
    ([20, 20, 37, 20, 21], 2, [20, 20, 37, 21]),
    ([20, 20, 37, 20, 21], 3, [20, 20, 37, 20, 21]),
    ([1, 1, 3, 3, 7, 2, 2, 2, 2], 1, [1, 3, 7, 2]),
    ([1, 1, 3, 3, 7, 2, 2, 2, 2], 2, [1, 1, 3, 3, 7, 2, 2]),
    ([1, 1, 3, 3, 7, 2, 2, 2, 2], 3, [1, 1, 3, 3, 7, 2, 2, 2]),
])
def test_delete_nth(order, max_e, result):
    assert delete_nth(order, max_e) == result
